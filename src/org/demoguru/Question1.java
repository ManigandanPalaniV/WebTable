...
public class Question1 {
	...
	public static void main(String[] args) throws IOException {
		...
		File dst = new File("D:\\Mani\\Selenium\\Day11\\Indexpage.png");
		...
		for (WebElement webElement : rowDetails) {
			List<WebElement> tableDetails = webElement.findElements(By.tagName("td"));
			for (WebElement webElement2 : tableDetails) {
